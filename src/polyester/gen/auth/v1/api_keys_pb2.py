...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_APIKEYSERVICE'].methods_by_name['CreateApiKey']._serialized_options = b'\272G\270\001\n\014Auth Service\022\016Create API Key\032\227\001Create a new API key for the caller account, including public key material and metadata. Requires the acting caller to have accepted the current terms.\230\265\030\002\202\323\344\223\002\026\"\021/v1/auth/api-keys:\001*'
  ...
  _globals['_APIKEYSERVICE']._serialized_end=3888

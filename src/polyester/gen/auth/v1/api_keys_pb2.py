...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_APIKEYSERVICE'].methods_by_name['CreateApiKey']._serialized_options = b'\272G\270\001\n\014Auth Service\022\016Create API Key\032\227\001Create a new API key for the caller account, including public key material and metadata. Requires the acting caller to have accepted the current terms.\230\265\030\002\242\265\030\001\001\202\323\344\223\002\026\"\021/v1/auth/api-keys:\001*'
  ...
  _globals['_APIKEYSERVICE'].methods_by_name['DeleteApiKey']._serialized_options = b'\272Gg\n\014Auth Service\022\016Delete API Key\032GRevoke an API key owned by the caller account. Revocation is permanent.\230\265\030\002\242\265\030\001\001\202\323\344\223\002\034*\032/v1/auth/api-keys/{key_id}'
  _globals['_APIKEYSERVICE'].methods_by_name['UpdateApiKey']._loaded_options = None
  _globals['_APIKEYSERVICE'].methods_by_name['UpdateApiKey']._serialized_options = b'\272Gn\n\014Auth Service\022\016Update API Key\032NUpdate mutable API key fields, including label, status, whitelist, and expiry.\230\265\030\002\242\265\030\001\001\202\323\344\223\002\0372\032/v1/auth/api-keys/{key_id}:\001*'
  ...
  _globals['_APIKEYSERVICE']._serialized_end=3903

...
class CreateSubaccountPolicyRequest(_message.Message):
    __slots__ = ("name", "description", "subaccount_id", "spot_markets", "perp_markets", "spot_market_scope", "perp_market_scope", "actions", "global_notional_cap", "max_order_notional", "max_open_orders", "max_open_positions", "global_perp_leverage_x", "daily_internal_transfer_out_limit", "daily_withdraw_limit", "internal_transfers_own_only", "enforce_withdraw_whitelist", "trading_halted", "liquidation_only", "daily_loss_limit", "intraday_drawdown_limit_bps", "locked", "review_at", "expires_at")
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    SUBACCOUNT_ID_FIELD_NUMBER: _ClassVar[int]
    SPOT_MARKETS_FIELD_NUMBER: _ClassVar[int]
...
class UpdateSubaccountPolicyRequest(_message.Message):
    __slots__ = ("policy_id", "name", "description", "spot_markets", "perp_markets", "spot_market_scope", "perp_market_scope", "actions", "global_notional_cap", "max_order_notional", "max_open_orders", "max_open_positions", "global_perp_leverage_x", "daily_internal_transfer_out_limit", "daily_withdraw_limit", "internal_transfers_own_only", "enforce_withdraw_whitelist", "trading_halted", "liquidation_only", "daily_loss_limit", "intraday_drawdown_limit_bps", "locked", "review_at", "expires_at")
    POLICY_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    SPOT_MARKETS_FIELD_NUMBER: _ClassVar[int]
    ...
    review_at: _timestamp_pb2.Timestamp
    expires_at: _timestamp_pb2.Timestamp
    def __init__(self, policy_id: _Optional[int] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., spot_markets: _Optional[_Iterable[_Union[SpotMarketRule, _Mapping]]] = ..., perp_markets: _Optional[_Iterable[_Union[PerpMarketRule, _Mapping]]] = ..., spot_market_scope: _Optional[_Union[MarketScope.Value, str]] = ..., perp_market_scope: _Optional[_Union[MarketScope.Value, str]] = ..., actions: _Optional[_Iterable[_Union[PolicyAction, str]]] = ..., global_notional_cap: _Optional[int] = ..., max_order_notional: _Optional[int] = ..., max_open_orders: _Optional[int] = ..., max_open_positions: _Optional[int] = ..., global_perp_leverage_x: _Optional[int] = ..., daily_internal_transfer_out_limit: _Optional[int] = ..., daily_withdraw_limit: _Optional[int] = ..., internal_transfers_own_only: _Optional[bool] = ..., enforce_withdraw_whitelist: _Optional[bool] = ..., trading_halted: _Optional[bool] = ..., liquidation_only: _Optional[bool] = ..., daily_loss_limit: _Optional[int] = ..., intraday_drawdown_limit_bps: _Optional[int] = ..., locked: _Optional[bool] = ..., review_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., expires_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class ApiPolicyView(_message.Message):
    __slots__ = ("id", "name", "description", "spot_markets", "perp_markets", "actions", "spot_market_scope", "perp_market_scope", "max_order_notional", "daily_internal_transfer_out_limit", "daily_withdraw_limit", "is_template", "source_template_id", "created_at", "updated_at")
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    SPOT_MARKETS_FIELD_NUMBER: _ClassVar[int]
...
class CreateApiPolicyRequest(_message.Message):
    __slots__ = ("name", "description", "spot_markets", "perp_markets", "spot_market_scope", "perp_market_scope", "actions", "max_order_notional", "daily_internal_transfer_out_limit", "daily_withdraw_limit", "is_template", "assign_to_key_id")
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    SPOT_MARKETS_FIELD_NUMBER: _ClassVar[int]
    PERP_MARKETS_FIELD_NUMBER: _ClassVar[int]
...
class UpdateApiPolicyRequest(_message.Message):
    __slots__ = ("policy_id", "name", "description", "spot_markets", "perp_markets", "spot_market_scope", "perp_market_scope", "actions", "max_order_notional", "daily_internal_transfer_out_limit", "daily_withdraw_limit", "is_template")
    POLICY_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    SPOT_MARKETS_FIELD_NUMBER: _ClassVar[int]

...
class AssetBalance(_message.Message):
    __slots__ = ("asset_id", "trading", "funding", "reserved", "available", "posted_version", "reserved_version")
    ASSET_ID_FIELD_NUMBER: _ClassVar[int]
    TRADING_FIELD_NUMBER: _ClassVar[int]
    FUNDING_FIELD_NUMBER: _ClassVar[int]
    RESERVED_FIELD_NUMBER: _ClassVar[int]
    AVAILABLE_FIELD_NUMBER: _ClassVar[int]
    POSTED_VERSION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, asset_id: _Optional[int] = ..., trading: _Optional[_Union[_u128_pb2.U128, _Mapping]] = ..., funding: _Optional[_Union[_u128_pb2.U128, _Mapping]] = ..., reserved: _Optional[_Union[_u128_pb2.U128, _Mapping]] = ..., available: _Optional[_Union[_u128_pb2.U128, _Mapping]] = ..., posted_version: _Optional[int] = ..., reserved_version: _Optional[int] = ...) -> None: ...
